...
## **Savings Institutions** (SIs)
  ...
  - Faced a major crisis during the 1982-1992 period resulting in the _failure of half of SIs._
...
## Credit Union
  ...
  - Because CUs are nonprofit organizations, their earnings are not taxed.
...
## Credit Union - 2
  ...
  - Most numerous of all depository institutions.
      - 6,105 CUs in 2016.
      - 107.6 million members. (WOW 1/3 of US!)
  - Less affected by the crisis of the 1980s that hit Saving Instituions (SIs) and Commercial Banks (CBs).
...
## Credit Union Trends
  ...
  - Recently, CUs have expanded their services to compete with Commercial Banks (CBs) and Savings Institutions (SIs).
  ...
  - Banking industry challenged CU expansion in 1997.
      - Feb 1998 - Supreme Court sided with the banking industry.
...
## Finance Companies (FC)
  ...
  - _Sales finance institutions_ specialize in loans to customers of a particular retailer or manufacturer.
  - _Personal credit institutions_ specialize in installment and other loans to consumers.
  - _Business credit institutions_ specialize in business loans, especially through equipment leasing and factoring.
...
## Finance Companies (FC) - 2
  ...
  - Many of the largest FCs tend to wholly owned or captive subsidiaries of major manufacturing companies.
...
## FC Balance Sheets
  ...
  - Some finance companies make loans to riskier customers at higher interest rates than CBs.
  - Sub-prime lenders are FCs that lend to high-risk customers.
  - Loan sharks are sub-prime lenders that charge unfairly exorbitant rates to desperate, sub-prime borrowers.
...
## FC Balance Sheets - 2
 ...
 - FCs often have advantages over CBs with respect to business loans because FCs:
...
## FC Performance
  ...
  - Problems arose in the FC industry in the mid- and late-2000s with the crash of the market for sub-prime mortgage loans.
  - Many FCs saw sharply lower equity values.
  - FCs are subject to state-imposed **usury** ceilings and additional restrictions have been imposed on payday loans in many states.
  - Because FCs do not accept deposits, they are not subject to the extensive oversight common among CBs, SIs, and CUs.
  - FC industry improved in the mid-2000s and early 2010s.
  - In the mid-2010s, industry median ROE rose to 9.33%, up from 6.61% during the height of the crisis, for business credit institutions.
  - During the mid-2010s, industry median ROE rose to 13.73%, up from 5.31% during the height of the crisis, for personal credit institutions.
...
## FC Performance 
  ...
  - Crash in the sub-prime mortgage market led to serious problems for the U.S. and worldwide economies as a whole.
  - Countrywide Financial failed, GMAC Financial Services was forced to convert to a bank holding company to prevent failure, and CIT Group also failed.
...
.footnote[[*] Source: [Dugan, Ianthe. "Consumers Find Investors Eager to Make 'Peer-to-Peer' Loans - WSJ.com." The Wall Street Journal - Breaking News, Business, Financial and Economic News, World News & Video - Wall Street Journal - Wsj.com. N.p., n.d. Web. 6 Aug. 2013.](http://online.wsj.com/article/SB100014241278873237408045786017737)]

---

## Borrower Enrollment Process

The borrower enrollment experience on a P2P lending site is straightforward with firms performing their due diligence through gathering readily availalble data.
...
* Website verifies borrower’s identity by requesting the borrower to mail copies of Social Security card, W-2 form, and other forms of identification 
...
Once enrolled, borrowers may publish a loan to the firms’ online platforms
  ...
  * Borrower’s loan profile is published on the website for investors to crowdfund, often in small increments
  * Once fully funded, a third party bank issues the loan to the borrower and creates sliced securities for each investor to collect returns from the borrower
  * Borrower makes payments back to P2P lending platform, which re-issues funds to security holders 
  * [Prospect Prospectus SEC](https://www.prosper.com/prospectus)
...
## Market Participants
  ...
  * Prosper
  * Lending Club
  * [Best Peer to Peer Lending 2020](https://www.thebalance.com/best-peer-to-peer-lending-companies-4580285)
  
---
  
## Key Take Aways
  
   * Lending Club and Prosper offer a viable option for qualified borrowers to receive a personal loan away from the traditional brick-and-mortar institutions. 
   * Shadow lending websites provide a one-stop-shop for borrowers to receive their loan, while providing the tools necessary to manage that loan. 
   * From a borrower’s perspective, it’s very difficult to be approved to join either website. Lending Club, for example, only accepts roughly 10% of all applicants. While this is beneficial for investors and those who qualify for these loans, by no means will these websites replace ‘pay-day loan’ boutiques. 

---
  
## Key Take Aways - 2
  
   * It seems unlikely for shadow lenders to move beyond loans over $40,000 without becoming heavily regulated. With an influx of investors joining because of the high ROI, P2P Lenders must ensure that borrower requirements do not dip to meet the demand. 
   * As many critics cite, the growth of these websites will help to alleviate any predatory loan practices by offering fair rates and not imposing substantial fees. 
